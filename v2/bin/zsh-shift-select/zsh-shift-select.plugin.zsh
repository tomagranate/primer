...
function {
        ...
        for     kcap   seq          widget (             # key name
                x      '^[[1;4D'    backward-word        # Shift + Option + LeftArrow
                x      '^[[1;4C'    forward-word         # Shift + Option + RightArrow
                x      '^[[1;4H'    beginning-of-buffer  # Shift + Option + Home
                x      '^[[1;4F'    end-of-buffer        # Shift + Option + End
        x      '^[[1;10D'   beginning-of-line    # Shift + Cmd + End
        x      '^[[1;10C'   end-of-line          # Shift + Cmd + End
        ); do
